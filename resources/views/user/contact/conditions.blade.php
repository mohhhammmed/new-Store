	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 offset-md-2 text-center">
				<!-- Title text -->
				<h3>{{website_translation('Terms & Conditions')}}</h3>
			</div>
		</div>
	</div>
	<!-- Container End -->
