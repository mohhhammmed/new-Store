		...
		<div class="row">
			<div class="col-md-12">
				<div class="search-result bg-gray">
					<h2> {{isset($maincategory)?__('trans.Results For') .' '. __('trans.'.$maincategory->type->type):__('trans.Results For Search')}}</h2>
...
<div class="widget category-list">
        ...
        <ul class="category-list">
            @foreach($branches as $branch)
                <li><a href="category.html">{{$branch->governorate}}<span>93</span></a></li>
            @endforeach
        </ul>
        @endif
</div>
