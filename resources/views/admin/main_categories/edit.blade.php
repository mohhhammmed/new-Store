...
@section('content')
    ...
    <section class="dashboard section">
        ...
        <div class="container">
          ...
          <form action="{{route('edit.category',$data_category->id)}}"method='POST'enctype='multipart/form-data'>
            @csrf
            ...
            <img width="120px" height="auto" src="{{asset('admin/images/categories/'.$data_category->image)}}"><br>
...
<div class="tab-content">
  ...
  <div class="tab-pane container active" id="home{{$trans->id}}">
    ...
    <form action="{{route('edit.category',$trans->id)}}"method='POST'enctype='multipart/form-data'>
      @csrf
      <input type='hidden' name="id"value='{{$trans->id}}'>
       {{-- photo --}}
       <label for="exampleFormControlInput1" class="form-label">Image Category</label>
            <img width="120px" height="auto" src="{{asset('admin/images/categories/'.$trans->image)}}"><br>
