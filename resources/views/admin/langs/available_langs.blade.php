          ...
          <table class="table table-responsive product-dashboard-table">
            ...
            <tbody>
                    ...
                    <td class="action" data-title="Action">
                      <div class="">
                        <ul class="list-inline justify-content-center">
                          ...
                          <li class="list-inline-item">
                            <a class="delete" data-toggle="tooltip" data-placement="top" title="Delete" href="{{route('delLang',$lang->id)}}">
              ...
              {{-- <tr>
                ...
                <td class="product-thumb">
                  <img width="80px" height="auto" src="store/images/products/products-2.jpg" alt="image description"></td>
              ...
              <tr>
                <td class="product-thumb">
                  <img width="80px" height="auto" src="store/images/products/products-3.jpg" alt="image description"></td>
                <td class="product-details">
              ...
              <tr>
                ...
                <td class="product-thumb">
                  <img width="80px" height="auto" src="store/images/products/products-4.jpg" alt="image description"></td>
                <td class="product-details">
                  <h3 class="title">Macbook Pro 15inch</h3>
              ...
              <tr>
                ...
                <td class="product-thumb">
                  <img width="80px" height="auto" src="store/images/products/products-1.jpg" alt="image description"></td>
                <td class="product-details">
                  <h3 class="title">Macbook Pro 15inch</h3>
