...
return [
    ...
    */
    ...
    'عقارات'=>"عقارات",
    'تسوق'=>"تسوق",
    'Join the millions who buy and sell from each other'=>'انضم إلى الملايين الذين يشترون ويبيعون من بعضهم البعض',
     'everyday in local communities around the world'=>'كل يوم في المجتمعات المحلية حول العالم',
    'Buy & Sell Near You'=>'بيع & شراء بالقرب منك',
    ...
    'Product Description'=>'وصف المنتج',
     'Product Specifications'=>'خصائص المنتج',
    'Product Review'=>'تقييم المنتج',
    'Payment after receiving delivery to all provinces'=>'الدفع بعد  الاستلام التوصيل لجميع المحافظات',
      'Have a great product to post ? Share it with your fellow users'=>
      'هل لديك منتج رائع للنشر؟
       شاركها مع زملائك المستخدمين
      ',
